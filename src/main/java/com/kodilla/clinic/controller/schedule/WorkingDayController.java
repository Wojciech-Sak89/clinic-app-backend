...
public class WorkingDayController {
    ...
    public List<WorkingDayDto> getWorkingDays() {
        return mapper.mapToWorkingDaysDtos(service.getAllWorkingDays());
    }
    ...
    public WorkingDayDto getWorkingDay(@PathVariable Integer dayId) throws WorkingDayNotFoundException {
        return mapper.mapToWorkingDayDto(service.getWorkingDay(dayId).orElseThrow(WorkingDayNotFoundException::new));
    }
    ...
    public WorkingDayDto addWorkingDay(@RequestBody WorkingDayDto workingDayDto) {
        return mapper.mapToWorkingDayDto(service.saveWorkingDay(mapper.mapToWorkingDay(workingDayDto)));
    }
    ...
    public void deleteWorkingDay(@PathVariable Integer dayId) {
        service.deleteWorkingDay(dayId);
    }
}
